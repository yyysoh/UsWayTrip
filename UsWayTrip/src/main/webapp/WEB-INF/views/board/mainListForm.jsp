  ...
  <div class="container">
    <div class="row">
        ...
        <div class="card card-transparent mb-7">
          ...
          <div class="card-body py-6">
            ...
            <c:forEach var="dto" begin="0" end="${fn:length(list) }" items="${list }">
				<c:if test="${dto.board_no eq 1 && idx<5}">
        ...
        <div class="card card-transparent mb-7">
          ...
          <div class="card-body py-6">
			...
			<c:forEach var="dto4" begin="0" end="${fn:length(list) }" items="${list }">
				<c:if test="${dto4.board_no eq 4 && idx<5 }">
					<c:set var="idx" value="${idx +1}"/>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card card-transparent mb-7">
          <a class="position-relative">
            <img class="card-img-top rounded lazyestload" data-src="${pageContext.request.contextPath}/resources/img/blog/blog-07.jpg" src="${pageContext.request.contextPath}/resources/img/blog/blog-07.jpg" alt="Card image cap">
            <div class="card-img-overlay card-hover-overlay rounded"></div>
          </a>
          ...
          <div class="card-body py-6">
			...
			<c:forEach var="dto7" begin="0" end="${fn:length(list) }" items="${list }">
				<c:if test="${dto7.board_no eq 7 && idx<5 }">
					<c:set var="idx" value="${idx +1}"/>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card card-transparent mb-7 mb-lg-0">
          <a class="position-relative">
            <img class="card-img-top rounded lazyestload" data-src="${pageContext.request.contextPath}/resources/img/blog/blog-013.jpg" src="${pageContext.request.contextPath}/resources/img/blog/blog-013.jpg" alt="Card image cap">
            <div class="card-img-overlay card-hover-overlay rounded"></div>
          </a>
          ...
          <div class="card-body py-6">
			...
			<c:forEach var="dto13" begin="0" end="${fn:length(list) }" items="${list }">
				<c:if test="${dto13.board_no eq 13 && idx<5 }">
					<c:set var="idx" value="${idx +1}"/>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card card-transparent mb-7 mb-md-0">
          <a class="position-relative">
            <img class="card-img-top rounded lazyestload" data-src="${pageContext.request.contextPath}/resources/img/blog/blog-019.jpg" src="${pageContext.request.contextPath}/resources/img/blog/blog-019.jpg" alt="Card image cap">
            <div class="card-img-overlay card-hover-overlay rounded"></div>
          </a>
          ...
          <div class="card-body py-6">
			...
			<c:forEach var="dto19" begin="0" end="${fn:length(list) }" items="${list }">
				<c:if test="${dto19.board_no eq 19 && idx<5 }">
					<c:set var="idx" value="${idx +1}"/>
