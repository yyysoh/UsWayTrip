...
// 		이메일 중복 검사
		function checkEmail(){
			...
			var httpURL = "${pageContext.request.contextPath}/admin/member/checkEmail?"+httpParam;
...
<div align = "center">
	<div  align = "center" style ="border:1px solid black; height:1300px; width:400px">
		<form action="${ pageContext.request.contextPath }/admin/member/insert" method="post" name = "input">
		<h2>회원가입</h2>
