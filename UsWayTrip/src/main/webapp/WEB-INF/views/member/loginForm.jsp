		...
		<form action ="${path}loginCheck" method = "post" name = "input" onsubmit = "return check(this)">
			...
			<!-- 이메일, 비밀번호 찾기 -->	
				<div style=" display:flex; justify-content: space-around; margin-right:20px">
					<div>
						<a href="${cpath }/comingSoon/comingSoonForm" style="font-size: 5px; margin-right:15px" >이메일 찾기</a>
					</div>
					<div>
						<a href="${cpath }/comingSoon/comingSoonForm" style="font-size: 5px">비밀번호 찾기</a>
					</div>
				</div>
			</div>
				<br>
